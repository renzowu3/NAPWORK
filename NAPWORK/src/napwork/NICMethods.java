...
public class NICMethods extends Device{
	...
	/*void setConfig(int param, boolean value){
		...
		case TCP_PSH: tcp_psh = value; break;
		case TCP_RST: tcp_rst = value; break;
		case TCP_SYN: tcp_syn = value; break;
		case TCP_FIN: tcp_fin = value; break;
		case TCP_RSV1: tcp_rsv1 = value; break;
		case TCP_RSV2: tcp_rsv2 = value; break;
		case D_FLAG: d_flag = value; break;
		case T_FLAG: t_flag = value; break;
		case RSV_FRAG: rsv_frag = value; break;
		case DONT_FRAG: dont_frag = value; break;
